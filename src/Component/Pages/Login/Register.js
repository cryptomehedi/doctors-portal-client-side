                        ...
                        <div className="form-control">
                            ...
                            <div className="relative w-full">
                                <div className="absolute inset-y-0 right-0 flex items-center px-2">
                                    ...
                                    <label onClick={() => setShow(!show)} className="bg-gray-300 hover:bg-gray-400 rounded px-2 py-1 text-sm text-gray-600 font-mono cursor-pointer js-password-label">{show ? 'Hide' : 'Show'}</label>
                                </div>
