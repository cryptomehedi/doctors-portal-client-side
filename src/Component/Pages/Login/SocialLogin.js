    ...
    return (
        <div>
            ...
            <div className='flex justify-center'>
                <button onClick={async ()=>{ await signInWithGoogle(); console.log(user);}} className="btn btn-outline hover:bg-gradient-to-r from-secondary to-primary">Continue With Google</button>
            </div>
